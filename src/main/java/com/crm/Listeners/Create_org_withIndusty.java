package com.crm.Listeners;
	...
	public class Create_org_withIndusty extends BaseClass implements ITestListener{
		...
		public void onStart(ITestContext context) {
			spark=new ExtentSparkReporter("./ExtentReport/Create_Org_with_industry Report.html");
			//configure the spark reporter
			spark.config().setDocumentTitle("Create_org Report");
